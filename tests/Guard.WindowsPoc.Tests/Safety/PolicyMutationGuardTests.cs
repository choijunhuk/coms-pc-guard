...
namespace Guard.WindowsPoc.Tests.Safety
{
    ...
    public sealed class PolicyMutationGuardTests
    {
        ...
        internal static readonly DateTimeOffset Now = DateTimeOffset.UtcNow;
        ...
        internal static PolicyMutationGuard Guard => new(Preview, Owner, @"C:\ComsPcGuardPoc\Fixtures\target.exe", new string('A', 64), TimeProvider.System);
        ...
        public void RejectsFixtureEscapeAndBroadOrOwnerDeny()
        {
            ...
            {
                Assert.IsFalse(new PolicyMutationGuard(Preview, Owner, path, new string('A', 64), TimeProvider.System).Evaluate(Attestation, Snapshot, true).Allowed);
            }
