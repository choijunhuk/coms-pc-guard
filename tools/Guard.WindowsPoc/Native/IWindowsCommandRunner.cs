...
namespace Guard.WindowsPoc.Native
{
    ...
    internal interface IPocMutationAuthorization
    {
        PocTransactionJournal Journal { get; }
        bool Restore { get; }
    ...
    {
        internal IPocMutationAuthorization? Authorization { get; init; }
        internal static WindowsCommandRequest Apply(IPocMutationAuthorization authorization)
        {
        ...
        internal static WindowsCommandRequest Restore(IPocMutationAuthorization authorization)
        {
            ArgumentNullException.ThrowIfNull(authorization);
